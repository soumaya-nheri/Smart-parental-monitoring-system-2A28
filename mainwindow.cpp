...
{/*cam = new QCamera(this);//
    ...
    ui->le_matricule_parents->setValidator( new QIntValidator(0, 9999, this));
        ...
        ui->le_nom_parents->setValidator(new QRegExpValidator( QRegExp("^[a-zA-Z]+$"), this ));
        ui->le_nom_parents_2->setValidator(new QRegExpValidator( QRegExp("^[a-zA-Z]+$"), this ));
        ui->le_prenom_parents->setValidator(new QRegExpValidator( QRegExp("^[a-zA-Z]+$"), this ));
        ui->le_prenom_parents_2->setValidator(new QRegExpValidator( QRegExp("^[a-zA-Z]+$"), this ));
       ...
       // ui->le_mail_parents_2->setValidator(new QRegExpValidator( QRegExp("^[a-zA-Z]+$"), this ));
        ui->le_adresse_parents->setValidator(new QRegExpValidator( QRegExp("^[a-zA-Z]+$"), this ));
        ui->le_adresse_parents_2->setValidator(new QRegExpValidator( QRegExp("^[a-zA-Z]+$"), this ));
        ...
        ui->le_type_machine->setValidator(new QRegExpValidator( QRegExp("^[a-zA-Z]+$"), this ));
        ui->le_type_machine_2->setValidator(new QRegExpValidator( QRegExp("^[a-zA-Z]+$"), this ));
        ui->le_etat_machine->setValidator( new QIntValidator(0, 2, this));
        ui->le_etat_machine_2->setValidator( new QIntValidator(0, 2, this));
        ui->le_emplacement_machine->setValidator(new QRegExpValidator( QRegExp("^[a-zA-Z]+$"), this ));
        ui->le_emplacement_machine_2->setValidator(new QRegExpValidator( QRegExp("^[a-zA-Z]+$"), this ));
...
void MainWindow::on_pb_ajouterEnfant_clicked()
{
    enfants en;
        ...
        en.setMatricule_parent(ui->lineEdit_parent->text().toInt());
