...
"}"));
        ...
        comboBox_parent->setGeometry(QRect(70, 120, 121, 22));
...
"}"));
        ...
        time->setGeometry(QRect(670, 0, 291, 41));
...
"border-color: rgb(170, 0, 255);"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        time->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:20pt; color:#aa00ff;\">k</span></p></body></html>", Q_NULLPTR));
